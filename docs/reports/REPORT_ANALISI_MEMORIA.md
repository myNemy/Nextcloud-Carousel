...
> ⚠️ **NOTA**: Questo è un documento storico che descrive un problema di memoria identificato e risolto. Le informazioni contenute si riferiscono allo stato del progetto al momento dell'analisi.
