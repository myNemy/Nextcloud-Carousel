...
> ⚠️ **NOTA**: Questo è un documento storico di verifica. Le informazioni contenute si riferiscono allo stato del progetto al momento della verifica (dicembre 2024).
